Face Detection:
    ...
    Module:pip install azure-cognitiveservices-vision-computervision==0.7.0
    ...
    In the AnalyzeFaces Function:
        # Specify features to be retrieved (faces)
        features = [VisualFeatureTypes.faces]
    Under # Get image analysis
    # Get image analysis
...
Using Face SDK:
    Module: pip install azure-cognitiveservices-vision-face==0.4.1
    Code:
        # Import namespaces
    ...
    Detect and analyse image:
        ...
        with open(image_file, mode="rb") as image_data:
            ...
            Option 1 runs the above code after python analyze-faces.py.
    Compare Faces:
    ...
    with open(image_2, mode="rb") as image_data:
        ...
        Run option 2 after running python analyze-faces.py

    Train Facial Recognition:

    In Train Model function:
    ...
    Option 4 after running python analyze-faces.py.

    Verify Face:

    In Verify Face function:
            ...
            with open(person_image, mode="rb") as image_data:
                ...
                if len(faces) > 0:
                    ...
                    if verification.is_identical:
                        result = 'Verified'
    Run option 5 after running python analyze-faces.py
Documenatation: https://docs.microsoft.com/en-us/azure/cognitive-services/computer-vision/concept-detecting-faces
